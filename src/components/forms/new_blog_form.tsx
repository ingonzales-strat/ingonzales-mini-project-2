"use client";
import { addBlog } from "@/lib/s_actions/blog-actions";
...
export default function BlogForm(){
    ...
    return <Form action={addBlog} className='max-w-2xl mx-auto border flex flex-col gap-5 p-5 rounded-md'>
      <div >
      ...
      <button type="submit" onClick={() => {router.push('/my_blogs'); router.refresh()   }} className="cursor-pointer hover:bg-blue-500 transition bg-blue-900 text-white px-4 py-2 mt-5 rounded">
        Post
      </button>
